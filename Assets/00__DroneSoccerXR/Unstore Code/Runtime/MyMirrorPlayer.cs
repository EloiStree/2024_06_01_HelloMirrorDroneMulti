...
using UnityEngine;
    ...
    public class MyMirrorPlayer : NetworkBehaviour
    {
        ...
        static readonly List<MyMirrorPlayer> playersList = new List<MyMirrorPlayer>();
        ...
        {
            byte playerNumber = 0;
            foreach (MyMirrorPlayer player in playersList)
